    ...
    if (product) {
      ...
      res.json({
        ...
        options: [
          ...
          { name: "Option7", value: product.option1, price: product.option1price },
          { name: "Option8", value: product.option2, price: product.option2price },
          { name: "Option9", value: product.option3, price: product.option3price },
          { name: "Option10", value: product.option4, price: product.option4price },
          { name: "Option11", value: product.option5, price: product.option5price },
          { name: "Option12", value: product.option6, price: product.option6price },
          { name: "Option13", value: product.option1, price: product.option1price },
          { name: "Option14", value: product.option2, price: product.option2price },
          { name: "Option15", value: product.option3, price: product.option3price },
          { name: "Option16", value: product.option4, price: product.option4price },
          { name: "Option17", value: product.option5, price: product.option5price },
          { name: "Option18", value: product.option6, price: product.option6price },
          { name: "Option19", value: product.option1, price: product.option1price },
          { name: "Option20", value: product.option2, price: product.option2price },
          { name: "Option21", value: product.option3, price: product.option3price },
          { name: "Option22", value: product.option4, price: product.option4price },
          { name: "Option23", value: product.option5, price: product.option5price },
          { name: "Option24", value: product.option6, price: product.option6price },
          { name: "Option25", value: product.option1, price: product.option1price },
          { name: "Option26", value: product.option2, price: product.option2price },
