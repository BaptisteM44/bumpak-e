...
//   }, [slug]);
//   useEffect(() => {
//     if (selectedOption && selectedOptionPrice !== null) {
//       const newCustom1Option = `${product.option1}:${selectedOption}${selectedOptionPrice > 0 ? '[+' + selectedOptionPrice + '.00]' : ''}`;
//       setCustom1Option(newCustom1Option);
//     }
...
//                 data-item-price={parseInt(product.price) + (selectedOption !== 'option1' ? parseInt(selectedOptionPrice) : 0)}
//                 data-item-description={product.description}
//                 data-item-custom1-name="Option" // Ajoutez cette ligne
//                 data-item-custom1-options={optionString}
//                 data-item-custom1-value={custom1Option}
//                 >
//                 Add to Cart
//               </button>
//               </div>
