...
//                   data-item-url={`/api/products/products/${product.slug}`}
...
function ProductDetails() {
  ...
  useEffect(() => {
    axios.get(`https://bumpak-e-production.up.railway.app/api/products/${slug}`)
      .then(response => {
        setProduct(response.data);
      })
            ...
            <div className="productDetails_config_firstpart">
              ...
              <div className="config_bag">
                <button
                  ...
                  data-item-url={`https://bumpak-e-production.up.railway.app/api/products/3dpouch`}
                  data-item-description={product.description}
                  // data-item-custom1-name="Option"
                  // data-item-custom1-options={optionString}
                  // data-item-custom1-type="readonly"
